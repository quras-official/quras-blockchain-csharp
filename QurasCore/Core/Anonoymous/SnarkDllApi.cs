...
namespace Quras.Core.Anonoymous
{
    public struct Temp
    {
    ...
    public class SnarkDllApi
    {
        ...
        public static extern bool Snark_MakeProof(byte[] pubKeyHash, byte[] anchor, Quras.Core.Anonoymous.JSInput[] input, Quras.Core.Anonoymous.JSOutput[] output, long vpub_old, long vpub_new); //For Windows
