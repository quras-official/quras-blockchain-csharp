...
using WalletCoin = Quras.Wallets.Coin;
using JSWalletCoin = Quras.Wallets.JSCoin;
using RCTWalletCoin = Quras.Wallets.RCTCoin;
using WalletKeyPair = Quras.Wallets.KeyPair;
