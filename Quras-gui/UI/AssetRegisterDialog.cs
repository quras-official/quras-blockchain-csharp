...
namespace Quras.UI
{
    public partial class AssetRegisterDialog : Form
    {
        ...
        public InvocationTransaction GetTransaction()
        {
            ...
            {
                sb.EmitSysCall("Quras.Asset.Create", asset_type, name, amount, precision, owner, admin, issuer, Fixed8.Zero, Fixed8.Zero, new UInt160());
        ...
        private void AssetRegisterDialog_Load(object sender, EventArgs e)
        {
            ...
            comboBox2.Items.AddRange(Program.CurrentWallet.GetContracts().Where(p => p.IsStandard).Select(p => ((KeyPair)Program.CurrentWallet.GetKey(p.PublicKeyHash)).PublicKey).ToArray());
